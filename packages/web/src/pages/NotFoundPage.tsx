  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--ui-bg-subtle)] px-4 text-[var(--ui-text)]">
      <div className="relative max-w-lg text-center">
        ...
        <div className="absolute -top-20 -left-20 h-40 w-40 rounded-full bg-[var(--ui-bg-active)] blur-3xl opacity-40" />
        <div className="absolute -bottom-20 -right-20 h-40 w-40 rounded-full bg-[var(--ui-bg-active)] blur-3xl opacity-40" />
        ...
        <div className="relative">
          ...
          <div className="mb-8 flex items-center justify-center">
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="flex h-24 w-24 items-center justify-center rounded-full bg-[var(--ui-btn-primary-bg)] shadow-lg">
                  <svg
                    aria-hidden="true"
          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link
              className="inline-flex items-center gap-2 rounded-md bg-[var(--ui-btn-primary-bg)] hover:bg-[var(--ui-btn-primary-bg-hover)] px-5 py-2.5 font-medium text-[var(--ui-btn-primary-text)] transition-colors"
              to="/"
            >
              <svg
                aria-hidden="true"
